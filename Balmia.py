...
number=int("+8801759137381")

devoloper_info={
    "Developer" :  'ARFAN ASHIQ',
    "Number" :  number,
    "Status" :  '24-ONLINE',
    "GitHub Url":  'https://github.com/CYBER-BD71',
    "Facebook" :  'facebook.com/Al-amin.0fficial',
    }
...
note1="""- __Inbox__ Me for Join `CYBER-BD71`\n- Try tool and **Review**"""
n1=Markdown(note1)
...
note4="""- Use Airplane mode in every 3.3 minutes \n- Use APN For Get More Ok ID \n- Cracking Started """
n4=Markdown(note4)
